...
class DealsControllerTest < ActionController::TestCase
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post :create, deal: { description: @deal.description, featured: @deal.featured, picture: @deal.picture }
    end
  ...
  test "should update deal" do
    put :update, id: @deal, deal: { description: @deal.description, featured: @deal.featured, picture: @deal.picture }
    assert_redirected_to deal_path(assigns(:deal))
  end
